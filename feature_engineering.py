...
def apply_features(df: pd.DataFrame) -> pd.DataFrame:
    ...
    # ===============================
    # 2️⃣ RỦI RO THIẾT BỊ (SỐ LƯỢNG → LOG)
    # ===============================
    ...
    # ===============================
    # 4️⃣ SỰ KHÔNG ỔN ĐỊNH CỦA ĐỊA CHỈ (ĐIỂM SỐ)
    # ===============================
